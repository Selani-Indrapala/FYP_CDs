...
flac_train_folder =  r'ASV_Data\Dataset200\Dataset200_train\flac' 
train_labels = 'ASV_Data\Dataset200_train.txt'
flac_val_folder = r'ASV_Data\Dataset200\Dataset200_val\flac' 
val_labels = 'ASV_Data\Dataset200_val.txt'
...
checkpoint_dir = "checkpoints\Dataset200_256"
...
plot_dir = "checkpoints\loss_plots"
...
for epoch in range(start_epoch, epochs):
    ...
    if min_tDCF <= min_tDCF_best:
        ...
        checkpoint_path = f"checkpoints/Dataset200_256/best_epoch_{epoch+1}.pth"
        torch.save({
            'epoch': epoch + 1,
    ...
    checkpoint_path = f"checkpoints/Dataset200_256/epoch_{epoch+1}.pth"
    torch.save({
        'epoch': epoch + 1,
        'model_state_dict': model.state_dict(),
        'optimizer_state_dict': optimizer.state_dict(),
